...
--- @param config Config
--- @param hp Helper
T.setup = function(c, config, hp)
  T.tab_highlight = c.tab
  T.underline_selected = config.plugins.bufferline.underline_selected
  T.underline_visible = config.plugins.bufferline.underline_visible
...
T.setup_bufferline_icon = function()
  ...
  local iconSkeleton = {
    ["BufferLine" .. icon_name .. "Selected"] = {
      bg = T.tab_highlight.activeBackground,
      fg = icon_color,
      sp = T.tab_highlight.activeBorder,
      underline = T.underline_selected,
    },
    ["BufferLine" .. icon_name] = {
      bg = T.tab_highlight.inactiveBackground,
      fg = icon_color,
    },
    ["BufferLine" .. icon_name .. "Inactive"] = {
      bg = T.tab_highlight.unfocusedActiveBackground,
      fg = icon_color,
      sp = T.tab_highlight.unfocusedActiveBorder,
      underline = T.underline_visible,
    },
  }
  return iconSkeleton
end
